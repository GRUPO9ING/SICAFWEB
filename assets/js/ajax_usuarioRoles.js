$(document).on("ready", function(){
  listar();
  /**/
    $("#frm-usuarioRoles").on("submit", function(e){
           e.preventDefault();
...
$("#tablaUsuarioRoles").on("click",".btnEditarUusarioRoles", function(){
  d = $(this).parents("tr").find("td");

      $('#id').val(d[1].innerText);
      $('#user').val(d[0].innerText);
      $('#rol').val(d[2].innerText);
  ...
  $("#tablaUsuarioRoles").on("click",".btnElinimarUsuarioRoles", function(){
    d = $(this).parents("tr").find("td");
...
function listar(){
  ...
  var table = $("#tablaUsuarioRoles").DataTable({
       "destroy": true,
       "responsive":true,
       "bDeferRender": true,
        "sPaginationType": "full_numbers",
        "ajax": {
          "url": "?c=UsuarioRoles&a=Listar",
          "type": "POST"
        },
        "columns": [
          { "data": "IdUR" , "class": "hidden"},
          { "data": "IdUser" },
          { "data": "IdRol" },
