...
function guardar(){
    ...
    $("#Enviar").on("click", function(){
           ...
           rules: {
             ...
             pw2: {required: true, pw: true, rangelength: [4, 30], equalTo:"#pw1"}
           ...
           messages: {
             ...
             pw2: {required: "Debe confirmar la contraseña",rangelength: "Máximo {1} caracteres",equalTo:"Las contraseñas no coinsiden"}
