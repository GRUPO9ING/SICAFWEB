  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="frm-insumo" data-locked="false" enctype="multipart/form-data">
                            ...
                            <div class="col col-md-12">
                              <div class="form-group">
                                ...
                                <div class="col col-md-9">
                                  ...
                                  <input type="text"  class="col col-md-12 fecha" placeholder="Fecha Compra" name="FechaComp" id="FechaComp" style="height:32px;"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="col col-md-9">
                                    <div class="input-group date fj-date">
                                      <input  type="text" class="col col-md-12 fecha" name="FechaVence" id="FechaVence" placeholder="Fecha Vence" style="height:32px;"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                      </div>
                                    </div>
                                   </div>
                                  </div>
